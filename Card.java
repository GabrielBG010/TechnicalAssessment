...
class Card {
  ...
  public Card(Suit p_suit,Value p_value)
  {
    m_suit = p_suit;
    m_value = p_value;
  ...
  // This line is used to compare the suits since the ordinal order
  //differ from the one in the instructions.
  private int mapSuite[] = {4,3,1,2};


  // Compares if the card suite of two cards are equal. 
  // @param[in] rhs   The right hand side card.
  // @return    true if equal.
  public boolean is_equal_suit( Card rhs )
  {
    return mapSuite[m_suit.ordinal()] == mapSuite[rhs.m_suit.ordinal()];
  }
  
  // Compares if the suit of the left card is less than the right.  
  // @param[in] rhs   The right hand side card.
  // @return    true if less than.
  public boolean is_less_than_suit( Card rhs )
  {
    return mapSuite[m_suit.ordinal()] < mapSuite[rhs.m_suit.ordinal()];
  }
  
  // Compares if the card suite of the left card is less than or equal the right.  
  // @param[in] rhs   The right hand side card.
  // @return    true if less than or equal.
  public boolean is_less_than_or_equal_suit( Card rhs )
  {
      return mapSuite[m_suit.ordinal()] <= mapSuite[rhs.m_suit.ordinal()];
  ...
  // @param[in] rhs   The right hand side card.
  // @return    true if greater than.
  public boolean is_greater_than_suit( Card rhs )
  {

    return mapSuite[m_suit.ordinal()] > mapSuite[rhs.m_suit.ordinal()];
  }
  
  // Compares if the card suite of the left card is greater than or equal the right.  
  //
  // @param[in] rhs   The right hand side card.
  // @return    true if greater than or equal.
  public boolean is_greater_than_or_equal_suite( Card rhs )
  {
    return mapSuite[m_value.ordinal()] >= mapSuite[rhs.m_value.ordinal()];
  }
